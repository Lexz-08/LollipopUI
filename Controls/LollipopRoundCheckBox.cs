...
public class LollipopRoundCheckBox : CheckBox
{
    #region Variables
    ...
    protected override void OnPaint(PaintEventArgs pevent)
    {
        ...
        //RadioButton Text
        g.DrawString(Text, font.Roboto_Medium10, new SolidBrush(Enabled ? EnabledStringColor : DisabledStringColor), 20, 1);
    }
